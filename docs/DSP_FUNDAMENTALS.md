...
Sonido extracts recurring DSP patterns into a shared vocabulary in `sonido-core`. This eliminates copy-paste duplication across the 36 effects while establishing consistent conventions.
