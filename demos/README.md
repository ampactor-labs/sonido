...
WAV files are gitignored. Run `make demo` to generate.
...
| `fx_ringmod.wav` | Ring Modulator | sine 440 Hz | frequency=220 Hz, depth=1, waveform=sine, mix=0.6 |
| `fx_stage.wav` | Stage (stereo utility) | saw chord | width=160%, haas_delay=12 ms |
